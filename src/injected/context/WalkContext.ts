...
export class WalkContext {
  ...
  /**
   * 【組2 偵察情報】父 instance → 該父層 dry-run 結果（即 sentinel.ts 的 `dryRunChildPropMap`）。
